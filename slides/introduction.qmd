...
::::{.incremental}
- Give a 'taste' of how binding compiled code looks like
...
In the course we will assume:

 - You are familiar and comfortable with Python
 - You have some prior experience with C/C++
   - Enough to read and write simple functions
   - Use `std::vector`, `std::string`, `std::function`
   - Have seen lambda expressions before e.g. `[](int x){return x*x;}`
...
::::{.incremental}
- How many of you have **written** a compiled code coupled to Python?
- How many of you have **run** a compiled code in Python?
::::
...
Please prefer the codespace for the course. Try on your machine during miniproject or at home.
...
::: {.attribution}
Photo by [Sheila Brown](https://www.publicdomainpictures.net/en/view-image.php?image=245390&picture=dachshund-dog-swimming-in-pool)
:::
